...
If this relative directory path is resolved against common base URI:
    ...
    https://github.com/openshift-kni/vse-sync-tests/tests/

then this test would have an absolute URI of:

    https://github.com/openshift-kni/vse-sync-tests/tests/sync/G.8272/time-error-in-locked-mode/1PPS-to-DPLL/PRTC-A/
